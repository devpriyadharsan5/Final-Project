...
def insertintotable():
    ...
    def get_historical(quote):
        ...
        df.to_csv(''+quote+'.csv')
        if(df.empty):
            ts = TimeSeries(key='PLWCGE3ALOCB555N',output_format='pandas')
    ...
    def ARIMA_ALGO(df):
        ...
        for company in uniqueVals[:10]:
            ...
            print("Tomorrow's",quote," Adjustcent Closing Price Prediction by ARIMA:",arima_pred)
            #rmse calculation
    ...
    def LSTM_ALGO(df):
        ...
        print()
        print("##############################################################################")
        print("Tomorrow's ",quote," Adjustcent Closing Price Prediction by LSTM: ",lstm_pred)
    ...
    def LIN_REG_ALGO(df):
        ...
        forecast_out = int(7)
        #Price after n days
        df['Adj Close after n days'] = df['Adj Close'].shift(-forecast_out)
        #New df with only relevant data
        df_new=df[['Adj Close','Adj Close after n days']]
        ...
        print()
        print("##############################################################################")
        print("Tomorrow's ",quote," Adjacent Closing Price Prediction by Linear Regression: ",lr_pred)
    ...
    def retrieving_tweets_polarity(symbol):
        ...
        auth = tweepy.OAuth2BearerHandler(ct.bearer_token)
